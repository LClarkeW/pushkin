...
'use strict';
  ...
  class SurveyDistractor{
    ...
    trial(display_element, trial) {
      ...
      var display_element_main_task = document.querySelector("#main_task");
      var display_element_distractor = document.querySelector("#distractor-stimulus-container");
      ...
      if (trial.randomize_image_order) {
        image_order = this.jsPsych.randomization.shuffle(image_order);
      }
  ...
  SurveyDistractor.info = info;

  export default SurveyDistractor;