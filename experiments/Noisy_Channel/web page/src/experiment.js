...
import jsPsychSurveyDistractor from './lib/jspsych-survey-distractor';
import jsPsychSurveyTextEdit from './lib/jspsych-survey-text-edit';
...
function build_timeline(jsPsych){
    ...
    var instructions1 = {
      ...
      stimulus: "<div style='text-align:left;'>In this task, we will ask you a variety of questions about your impressions, activities, beliefs, preferences, etc. " +
    ...
    var instructions2 = {
      type: jsPsychHtmlButtonResponse,
      stimulus: "While you are completing your sentence, there will be geometric shapes appearing at the bottom of the screen. " +
        ...
        "<br></br>" +
        "<div class='center'><img src='./assets/images/target.png'></img>" +
