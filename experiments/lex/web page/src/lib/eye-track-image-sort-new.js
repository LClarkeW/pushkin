import { ParameterType } from 'jspsych';
    ...
    const info = {
      name: "eye-track-image-sort",//change made
      description: '',
    parameters: {
      images: {
    ...
    var trial_data = {
      ...
      for (let i = 0; i < draggables.length; i++) {
        ...
        const after_response = (info) => {
          ...
          if(has_entered_image && audio_done && !this.isTrialEnded){
        ...
        const end_trial = () => {
          ...
          console.log(trial_data.screen_width)
          console.log(document.querySelector('#jspsych-free-sort-arena'))
...
EyeTrackImageSort.info = info;

export { EyeTrackImageSort as default };